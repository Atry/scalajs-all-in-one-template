# The All-in-One Scala.js web project template
...
This repository contains the basic structure for a Scala web project with the following technologies built-in:
